...
export default function ProjectsPage() {
  return (
    <section id="projects" className='bg-gradient-to-b from-black to-gray-950 text-white'>
      <h2 className='md:text-4xl text-3xl font-bold text-center  '>Projects</h2>
...
Users can search by country name, filter by region, switch between light/dark mode, and view detailed information including population, currencies, and border countries." techSkills={["React", "ReactDom ", "FetchApi", "Tailwind"]} />
    </section>
  )
}
